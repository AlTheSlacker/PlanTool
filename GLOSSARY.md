...
| **stage** | package | The methodology's ordered steps are the standard package set for planning work — the same kind of chunk as a build package, in a different table. Retired 2026-07-21; methodology assets are `package1_context.md` … `package8_finalization.md` at **rev 3**. |
